...
- Keep the C# test baseline at Core 58, IO 42, Desktop 97, total 197, with zero failures and skips.
...
Expected: MATLAB passes; .NET remains 197/197 with zero failures/skips.
...
Expected: both layout tests pass; .NET remains 197/197; MATLAB passes.
...
Expected: MATLAB passes; .NET reports 197 passed; ignored
...
Expected: .NET build has zero warnings/errors; Core 58, IO 42, Desktop 97 pass;
...
Core 58, IO 42, Desktop 97, total 197.
...
- MATLAB and all 197 .NET tests pass;
